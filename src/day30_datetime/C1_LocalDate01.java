...
public class C1_LocalDate01 {
	...
	public static void main(String[] args) {
		// Java' da sadece tarih kullanmak isitiyorsak 
		// LocalDate class indan obje uretiriz
		...
		LocalDate dogumGunu= LocalDate.of(1984, 01, 20);
		...
		// Localdate.of methodu kullaniyoruz
