...
public class YesilMarket {
	...
	public static List<String> urunler= new ArrayList<>();// Global degisken de diyebilirz, "class level" list 
	...
	public static void main(String[] args) {
		...
		System.out.println("Lutfen urun agirligi giriniz");
		double kg=scan.nextDouble();
		
		sepeteEkle(urunNo,kg);
		
		
		urunler.addAll(Arrays.asList("Domates", "Patates", "Biber", "Sogan", "Havuc", "Elma","Muz", "Cilek",
				                     "Kavun", "Uzum", "Limon"));
		
		fiyatlar.addAll(Arrays.asList(2.10, 3.20, 1.50, 2.30, 3.10, 1.20, 1.90, 6.10, 4.30, 2.70, 0.50));
		
		urunListele();
		System.out.println("Lutfen urununuzu numaraya gore seciniz");
