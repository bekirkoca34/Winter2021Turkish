...
public class Exceptions02 {
	public static void main(String[] args) {
		...
		while (count <= 100) {
			...
			/*
			 * java'ya exceptions'i handle etmek icin bir cozum uretmezsek java exception
			 * ile karsilastiginda calismayi durdurur (stops execution) throws exception
			 * (exception firlatir)(problemin kaynagini bize gosterir)
			 * 
			 * tum aplication durmus olur... Musterinin kullandigi bir uygulama icin bu
			 * KABUL EDILEMEZ BUnun icin kod yazan kisi muhtemel sorunlari ongormeli ve
