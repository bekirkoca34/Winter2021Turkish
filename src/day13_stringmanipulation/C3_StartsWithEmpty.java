...
public class C3_StartsWithEmpty {
	...
	public static void main(String[] args) {
		...
		String str2="";
		System.out.println(str2.isEmpty());// true // cebimde para yok
		System.out.println(str2.isBlank());
		
		String str3=null;// null bir deger degildir, sadece str3 bir pointer dir.
